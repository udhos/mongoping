...
# the ./docs dir is published as https://udhos.github.io/mongoping/

# generate chart package from source
helm package ./charts/mongoping -d ./docs

# regenerate the index from existing chart packages
helm repo index ./docs --url https://udhos.github.io/mongoping/
